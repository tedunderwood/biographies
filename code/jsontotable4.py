...
# Edited June 2017. It translates the jsons produced by
# David Bamman's BookNLP pipeline into a simpler text file.

# Based on jsontotable3.py. This unpacks characters from
# jsons. In doing that it has to
# 1) choose a name for the character; there may be several
# names listed in the json
